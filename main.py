...
stopuser = {}
token = "7823331004:AAEkhJYcSVe_VCTp9ieDbTy4m9m0iMne1Lc"
	...
	def my_function():
	  ...
	  "plan": "Free - Not Subscribed",
		...
		if BL == 'Free - Not Subscribed':	
			...
			contact_button = types.InlineKeyboardButton(text="⚆ 𝗣𝗿𝗼𝗴𝗿𝗮𝗺𝗺𝗲𝗿 - CN", url="https://t.me/JAINKINGJOINBOT")
...
┃⌧ 𝗗𝗘𝗩 <a href='t.me/JAINKINGJOINBOT'> JAIN KING</a>  
┗━━━━━━━━/━━━━━━━━⍟''',reply_markup=keyboard)
			return
		keyboard = types.InlineKeyboardMarkup()
		contact_button = types.InlineKeyboardButton(text="⚆ Our Channel ⚆", url="https://t.me/JAINKINGJOINBOT")
		keyboard.add(contact_button)
...
def dato(zh):
	...
	try:
		...
		mn = f'''<a href='t.me/JAINKINGJOINBOT'>-</a> 𝐈𝐧𝐟𝐨: <code>{brand} - {card_type} - {level}</code>
<a href='t.me/JAINKINGJOINBOT'>-</a> 𝐁𝐚𝐧𝐤: <code>{bank} </code>
<a href='t.me/JAINKINGJOINBOT'>-</a> 𝐂𝐨𝐮𝐧𝐭𝐫𝐲: <code>{country_name} [ {country_flag} ]</code>'''
		return mn
	except Exception as e:
		print(e)
		return 'No info'
...
⚆ 𝗚𝗔𝗧𝗘 -> {gate} 💫
⚆ 𝗣𝗿𝗼𝗴𝗿𝗮𝗺𝗺𝗲𝗿<a href='t.me/JAINKINGJOINBOT'>『JAIN KING</a> </b>''', 
                        reply_markup=mes)

                    msg = f'''
<a href='t.me/JAINKINGJOINBOT'>-</a> 𝐀𝐩𝐩𝐫𝐨𝐯𝐞𝐝 ✅
<a href='t.me/JAINKINGJOINBOT'>┏━━━━━━━━━━━⍟</a>			
<a href='t.me/JAINKINGJOINBOT'>┃</a>𝐂𝐂 <code>{cc}</code><a href='t.me/JAINKINGJOINBOT'>┗━━━━━━━⊛</a>
<a href='t.me/JAINKINGJOINBOT'>-</a> 𝐆@𝐭𝐞𝐰𝐚𝐲: <code>ST®IPE CHA®GE 1$</code>		
<a href='t.me/JAINKINGJOINBOT'>-</a> 𝐑𝐞𝐬𝐩𝐨𝐧𝐬𝐞: <code>Payment Successful 🎉</code>

{str(dato(cc[:6]))}

<a href='t.me/JAINKINGJOINBOT'>-</a> 𝐓𝐢𝐦𝐞: <code>{"{:.1f}".format(execution_time)} 𝐬𝐞𝐜𝐨𝐧𝐝</code> 
<a href='t.me/JAINKINGJOINBOT'>-</a> 𝐂𝐡𝐞©𝐤𝐞𝐝 𝐁𝐲: @{user_username}
<a href='t.me/JAINKINGJOINBOT'>-</a> 𝐁𝐨𝐭 𝐀𝐛𝐨𝐮𝐭: <a href='t.me/JAINKINGJOINBOT'>⏤͟͞𝐌𝐚𝐬𝐬 𝐂𝐡𝐞𝐜𝐤𝐞𝐫 𝐁𝐨𝐭</a>'''

                    if 'success' in last or 'Stripe Error: Your card insufficient funds.' in last or 'Thank you for supporting' in last or 'Your card does not support this type of purchase.' in last or "Your card's security code is invalid." in last or 'Membership confirmation' in last or 'Thank You for your donation' in last or 'Invalid account.' in last or 'The zip code you supplied failed validation.' in last or 'Stripe Error: Your card security code is incorrect' in last or 'stripe_3ds2_fingerprint' in last or 'Your card security code is invalid.' in last or 'Stripe Error: Your card has insufficient funds.' in last or 'Your card has insufficient funds.' in last or 'Invalid account.' in last or 'zip code is incorrect' in last or 'three_d_secure' in last or 'security code is incorrect' in last or 'security code is invalid' in last or 'authentication required' in last or "Stripe Error: Your card's security code is invalid." in last or "Your card's security code is incorrect." in last or 'Verifying strong customer authentication. Please wait...' in last or 'Thank you for your message. We will get in touch with you shortly' in last or '3D LIVE ✅' in last or 'CCN/CVV LIVE ✅' in last or 'CHARGE ✅' in last:
                        live += 1
...
<a href='t.me/JAINKINGJOINBOT'>┏━━━━━━━━━━━⍟</a>			
<a href='t.me/JAINKINGJOINBOT'>┃</a>𝐂𝐂 <code>{cc}</code><a href='t.me/JAINKINGJOINBOT'>┗━━━━━━━⊛</a>
<a href='t.me/JAINKINGJOINBOT'>-</a> 𝐆@𝐭𝐞𝐰𝐚𝐲 : <code>Braintree Auth</code>		
<a href='t.me/JAINKINGJOINBOT'>-</a> 𝐑𝐞𝐬𝐩𝐨𝐧𝐬𝐞: <code>Approved</code>
...
<a href='t.me/JAINKINGJOINBOT'>┏━━━━━━━━━━━⍟</a>			
<a href='t.me/JAINKINGJOINBOT'>┃</a>𝐂𝐂 <code>{cc}</code><a href='t.me/JAINKINGJOINBOT'>┗━━━━━━━⊛</a>
<a href='t.me/JAINKINGJOINBOT'>-</a> 𝐆@𝐭𝐞𝐰𝐚𝐲 : STRIPE AUTH
<a href='t.me/JAINKINGJOINBOT'>-</a> 𝐑𝐞𝐬𝐩𝐨𝐧𝐬𝐞:  Approved

{str(dato(cc[:6]))}

<a href='t.me/JAINKINGJOINBOT'>-</a> 𝐓𝐢𝐦𝐞: <code>1{"{:.1f}".format(execution_time)} 𝐬𝐞𝐜𝐨𝐧𝐝</code> 
<a href='t.me/JAINKINGJOINBOT'>-</a> 𝐂𝐡𝐞©𝐤𝐞𝐝 𝐁𝐲: @{user_username}
<a href='t.me/JAINKINGJOINBOT'>-</a> 𝐁𝐨𝐭 𝐀𝐛𝐨𝐮𝐭: <a href='t.me/JAINKINGJOINBOT'>⏤͟͞𝐌𝐚𝐬𝐬 𝐂𝐡𝐞𝐜𝐤𝐞𝐫 𝐁𝐨𝐭</a>'''

                    if 'success' in last or 'Stripe Error: Your card insufficient funds.' in last or 'Thank you for supporting' in last or 'Your card does not support this type of purchase.' in last or "Your card's security code is invalid." in last or 'Membership confirmation' in last or 'Thank You for your donation' in last or 'Stripe Error: Your card incorrect_cvc' in last or 'The zip code you supplied failed validation.' in last or 'Stripe Error: Your card security code is incorrect' in last or 'stripe_3ds2_fingerprint' in last or 'Your card security code is invalid.' in last or 'Stripe Error: Your card has insufficient funds.' in last or 'Your card has insufficient funds.' in last or 'Invalid account.' in last or 'zip code is incorrect' in last or 'three_d_secure' in last or 'security code is incorrect' in last or 'security code is invalid' in last or 'authentication required' in last or "Stripe Error: Your card's security code is invalid." in last or "Your card's security code is invalid." in last or 'Verifying strong customer authentication. Please wait...' in last or 'Thank you for your message. We will get in touch with you shortly' in last or 'APPROVED ✅' in last or '3D LIVE ✅' in last or 'CCN/CVV LIVE ✅' in last or 'CHARGE ✅' in last:
                        live += 1
                        bot.send_message(call.from_user.id, msg)
                    else:
                        dd += 1
...
<a href='t.me/JAINKINGJOINBOT'>┏━━━━━━━━━━━⍟</a>			
<a href='t.me/JAINKINGJOINBOT'>┃</a>𝐂𝐂 <code>{cc}</code><a href='t.me/JAINKINGJOINBOT'>┗━━━━━━━⊛</a>
<a href='t.me/JAINKINGJOINBOT'>-</a> 𝐆@𝐭𝐞𝐰𝐚𝐲: <code>ST®IPE CHA®GE 2.99$</code>		
<a href='t.me/JAINKINGJOINBOT'>-</a> 𝐑𝐞𝐬𝐩𝐨𝐧𝐬𝐞: <code>{last}</code>
...
<a href='t.me/JAINKINGJOINBOT'>┏━━━━━━━━━━━⍟</a>			
<a href='t.me/JAINKINGJOINBOT'>┃</a>𝐂𝐂 <code>{cc}</code>
<a href='t.me/JAINKINGJOINBOT'>┗━━━━━━━⊛</a>
<a href='t.me/JAINKINGJOINBOT'>-</a> 𝐆𝐚𝐭𝐞𝐰𝐚𝐲: <code>STRIPE CHARGE 1$</code>		
<a href='t.me/JAINKINGJOINBOT'>-</a> 𝐑𝐞𝐬𝐩𝐨𝐧𝐬𝐞: <code>{last}</code>

{str(dato(cc[:6]))}

<a href='t.me/JAINKINGJOINBOT'>-</a> 𝐓𝐢𝐦𝐞: <code>{"{:.1f}".format(execution_time)} 𝐬𝐞𝐜𝐨𝐧𝐝</code> 
<a href='t.me/JAINKINGJOINBOT'>-</a> 𝐂𝐡𝐞𝐜𝐤𝐞𝐝 𝐁𝐲: <a href='t.me/{user_username}'>{user_name}</a>
<a href='t.me/JAINKINGJOINBOT'>-</a> 𝐁𝐨𝐭 𝐀𝐛𝐨𝐮𝐭: <a href='t.me/JAINKINGJOINBOT'>⏤͟͞𝐌𝐚𝐬𝐬 𝐂𝐡𝐞𝐜𝐤𝐞𝐫 𝐁𝐨𝐭</a>'''
...
<a href='t.me/JAINKINGJOINBOT'>┃</a>𝐂𝐂 <code>{cc}</code>
<a href='t.me/JAINKINGJOINBOT'>┗━━━━━━━⊛</a>
<a href='t.me/JAINKINGJOINBOT'>-</a> 𝐆@𝐭𝐞𝐰𝐚𝐲: <code>ST®IPE CHARGE 1$</code>		
<a href='t.me/JAINKINGJOINBOT'>-</a> 𝐑𝐞𝐬𝐩𝐨𝐧𝐬𝐞: <code>Payment Successful 🎉</code>

{str(dato(cc[:6]))}

<a href='t.me/JAINKINGJOINBOT'>-</a> 𝐓𝐢𝐦𝐞: <code>{"{:.1f}".format(execution_time)} 𝐬𝐞𝐜𝐨𝐧𝐝</code> 
<a href='t.me/JAINKINGJOINBOT'>-</a> 𝐂𝐡𝐞©𝐤𝐞𝐝 𝐁𝐲: <a href='t.me/{user_username}'>{user_name}</a>
<a href='t.me/JAINKINGJOINBOT'>-</a> 𝐁𝐨𝐭 𝐀𝐛𝐨𝐮𝐭: <a href='t.me/JAINKINGJOINBOT'>⏤͟͞𝐌𝐚𝐬𝐬 𝐂𝐡𝐞𝐜𝐤𝐞𝐫 𝐁𝐨𝐭</a>'''
...
⚆ 𝗣𝗿𝗼𝗴𝗿𝗮𝗺𝗺𝗲𝗿<a href='t.me/JAINKINGJOINBOT'>『JAIN KING</a>''')
...
<a href='t.me/JAINKINGJOINBOT'>┃</a>𝐂𝐂 <code>{cc}</code>
<a href='t.me/JAINKINGJOINBOT'>┗━━━━━━━⊛</a>
<a href='t.me/JAINKINGJOINBOT'>-</a> 𝐆𝐚𝐭𝐞𝐰𝐚𝐲: <code>Braintree Auth</code>		
<a href='t.me/JAINKINGJOINBOT'>-</a> 𝐑𝐞𝐬𝐩𝐨𝐧𝐬𝐞: <code>Declined - Call Issuer</code>
...
<a href='t.me/JAINKINGJOINBOT'>┃</a>𝐂𝐂 <code>{cc}</code>
<a href='t.me/JAINKINGJOINBOT'>┗━━━━━━━⊛</a>
<a href='t.me/JAINKINGJOINBOT'>-</a> 𝐆𝐚𝐭𝐞𝐰𝐚𝐲: <code>STRIPE CHARGE 3$</code>		
<a href='t.me/JAINKINGJOINBOT'>-</a> 𝐑𝐞𝐬𝐩𝐨𝐧𝐬𝐞: <code>{last}</code>
...
<a href='t.me/JAINKINGJOINBOT'>┃</a>𝐂𝐂 <code>{cc}</code>
<a href='t.me/JAINKINGJOINBOT'>┗━━━━━━━⊛</a>
<a href='t.me/JAINKINGJOINBOT'>-</a> 𝐆𝐚𝐭𝐞𝐰𝐚𝐲: ⤿ 𝘚𝘛𝘙𝘐𝘗𝘌 𝘈𝘜𝘛𝘏 🟢 ⤾		
<a href='t.me/JAINKINGJOINBOT'>-</a> 𝐑𝐞𝐬𝐩𝐨𝐧𝐬𝐞: <code>{last}</code>
...
<a href='t.me/JAINKINGJOINBOT'>┗━━━━━━━⊛</a>
<a href='t.me/JAINKINGJOINBOT'>-</a> 𝐆𝐚𝐭𝐞𝐰𝐚𝐲: ⤿ 𝘚𝘛𝘙𝘐𝘗𝘌 𝘈𝘜𝘛𝘏 🟢 ⤾		
<a href='t.me/JAINKINGJOINBOT'>-</a> 𝐑𝐞𝐬𝐩𝐨𝐧𝐬𝐞: ⤿ 𝘕𝘪𝘤𝘦! 𝘕𝘦𝘸 𝘱𝘢𝘺𝘮𝘦𝘯𝘵 𝘮𝘦𝘵𝘩𝘰𝘥 𝘢𝘥𝘥𝘦𝘥 ✅ ⤾
...
• Bot Subscription @JAINKINGJOINBOT
'''
